        ...
        <div class="row" style="gap:2rem;align-items:flex-start;">
                        ...
                        <tbody>
                            @foreach($cartItems as $item)
                                <tr>
                                    ...
                                    <td style="color:var(--primary);">{{number_format($item->quantity * $item->product->price)}} đ
                                    </td>
                                    <td>
            ...
            <div class="col" style="flex:1;">
                <div class="glassContainer" style="padding:2rem;position:sticky;top:120px;">
                    <h3 class="mb4" style="border-bottom:1px solid var(--glassBorder);padding-bottom:1rem;">Tổng Quan Đơn Hàng
                    </h3>
