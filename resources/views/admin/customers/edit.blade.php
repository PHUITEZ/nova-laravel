            ...
            <div style="background:var(--bg-card);border:1px solid var(--border-light);border-radius:12px;padding:3rem;">
                <form action="{{route('admin.customers.update', $user->id)}}" method="POST">
                    ...
                    <div style="display:grid;grid-template-columns:1fr 1fr;gap:1.5rem;margin-bottom:1.5rem;">
                        <div>
                            <label style="display:block;margin-bottom:0.5rem;color:var(--text-light);font-size:0.9rem;">Họ
                                Tên</label>
                            <input type="text" name="name" class="formInput" value="{{$user->name}}" required>
                        </div>
                        <div>
                            <label
                                style="display:block;margin-bottom:0.5rem;color:var(--text-light);font-size:0.9rem;">Email</label>
                    ...
                    <div style="display:grid;grid-template-columns:1fr 1fr;gap:1.5rem;margin-bottom:2rem;">
                        ...
                        <div>
                            <label style="display:block;margin-bottom:0.5rem;color:var(--text-light);font-size:0.9rem;">Địa
                                Chỉ</label>
