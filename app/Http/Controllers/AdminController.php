...
return view('admin.dashboard',compact('orders','totalOrders','totalProducts','revenue'));
}
...
$validated=$request->validate(['name'=>'required','price'=>'required|integer','categoryId'=>'required','image'=>'required','stock'=>'required|integer','description'=>'nullable']);
